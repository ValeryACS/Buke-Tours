...
<html lang="es">
  ...
  <body>
    ...
    >
      ...
      <form id="profile-form" novalidate>
        <div class="row g-3">
          ...
          <div class="col-12 col-md-6">
            <label for="password" class="form-label d-flex text-start"
          ...
          <div class="col-12 col-md-6">
            <label for="confirm-password" class="form-label d-flex text-start"
              >Confirmar
              <?php echo $lang['contrasena'] ?></label
            >
            <input
          ...
          <div class="col-12 col-md-6 form-group text-start mb-3">
            <label for="birthdate" class="form-label d-flex text-start"
          ...
          <div class="col-12 col-md-6 form-group text-start mb-3">
            <label class="form-label d-block d-flex text-start">Género</label>
            <div class="form-check form-check-inline">
              <input
                ...
                checked
              />
              <label class="form-check-label d-flex text-start" for="masculino"
                >Masculino</label
              >
            </div>
            <div class="form-check form-check-inline">
              <input
                ...
                value="Femenino"
              />
              <label class="form-check-label d-flex text-start" for="femenino"
                >Femenino</label
              >
            </div>
          </div>
          ...
          <div class="col-12 col-md-6 form-group">
            <span id="flagCountry" class="fi d-none" aria-hidden="true"></span>
          ...
          <div class="col-12 col-md-12 form-group text-start">
            <label for="documento" class="form-label d-flex text-start"
          ...
          <div class="col-6 col-md-3">
            <label for="provincia" class="form-label d-flex text-start"
              >Provincia</label
            >
            <input
              id="provincia"
    ...
    ?>
    <script type="module" src="/Buke-Tours/assets/js/signup.pge.js" defer></script>
  </body>
</html>
