        ...
        <input type="hidden" id="admin_id" name="admin_id" value="<?= $adminIdActual ?>">
            ...
            <div class="col-12">
                ...
                <input
                    ...
                    autocomplete="name"
                    value="<?= htmlspecialchars($adminSeleccionado['full_name'] ?? '')?>"
                />
            </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <input
                    ...
                    autocomplete="email"
                    value="<?= htmlspecialchars($adminSeleccionado['email'] ?? '')?>"
                />
            </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <input
                    ...
                    autocomplete="tel"
                    inputmode="tel"
                    value="<?= htmlspecialchars($adminSeleccionado['phone'] ?? '')?>"
                />
            </div>
            ...
            <div class="col-12 col-md-6 form-group text-start mb-3">
                ...
                <input
                    ...
                    id="birthdate"
                    name="birthdate"
                    value="<?= htmlspecialchars($adminSeleccionado['birth_date'] ?? '')?>"
                />
            </div>
            <div class="col-12 col-md-6 form-group text-start mb-3">
            ...
            <div class="col-12 col-md-12 form-group text-start">
                ...
                <input
                    ...
                    maxlength="20"
                    value="<?= htmlspecialchars($adminSeleccionado['passport'] ?? '')?>"
                />
            </div>
            <div class="col-12 text-start">
                ...
                <input
                    ...
                    maxlength="200"
                    value="<?= htmlspecialchars($adminSeleccionado['home_addres'] ?? '')?>"
                />
            </div>
            <div class="col-12 col-md-6">
                ...
                <input
                    ...
                    class="form-control"
                    maxlength="50"
                    value="<?= htmlspecialchars($adminSeleccionado['city'] ?? '')?>"
                />
            </div>
            <div class="col-6 col-md-3">
                ...
                <input
                    ...
                    class="form-control"
                    maxlength="60"
                    value="<?= htmlspecialchars($adminSeleccionado['province'] ?? '')?>"
            ...
            <div class="col-6 col-md-3">
                ...
                <input
                    ...
                    maxlength="30"
                    value="<?= htmlspecialchars($adminSeleccionado['zip_code'] ?? '')?>"
...
<script type="module" src="/Buke-Tours/assets/js/admins/edit-profile-page.js"  defer></script>
</body>
</html>